...
<?php
    ...
    //$year = $_SESSION["year"];
  include 'config.php';
$query = "SELECT  `name`, `roll`, `year`, `branch`, `reason`, `date1`, `date2` , `id3` FROM `lib1` WHERE `approve`='2' && `branch`='$branch'  ORDER BY `id3` desc";
...
<?php
    ...
    //$year = $_SESSION["year"];
  include 'config.php';
$query = "SELECT  `name`, `roll`, `year`, `branch`, `reason`, `date1`, `date2` , `id3` FROM `lib1` WHERE `approve`='4'  && `branch`='$branch'  ORDER BY `id3` desc";
 ...
 <a href="hod1.php"  button class="contact100-form-btn">back</a>
 </div>
