...
.card{max-width: 250px;min-width: 200px;}
</style>
...
<?php
    ...
    $year = $_SESSION["year"];
  include 'config.php';
$query = "SELECT  `name`, `roll`, `year`, `branch`, `reason`, `date1`, `date2` ,`image`, `id3` FROM `lib1` WHERE `approve`='0' && `year`='$year' && `branch`='$branch'  ORDER BY `id3` desc";
...
<a href="cc2.php"  button class="contact100-form-btn">approved/denayed aplications</a>
</div>
...
if (isset($_POST['approve'])) {
		 ...
		 $id3 = $_POST['id3'];
					  ...
					  $sql="update lib1 set `approve`= 1  where id3='$id3' ";
						include 'config.php';
				...
				else if ($branch='elect') {


								$to =  'hodelect@gmail.com';
								$subject = 'leave application from' ;
								$message = 'ok' ;
								$from = 'From: <abc@gmail.com>'. "\r\n";
			    ...
			    location.href='cc1.php'
					...
					if (isset($_POST['deny'])) {
 				 	$id3 = $_POST['id3'];
											...
											$sql="update lib1 set `approve`= 3  where id3='$id3' ";
										include 'config.php';
